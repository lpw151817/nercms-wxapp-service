...
public class ConferencePersonDao extends BaseDAO {
	...
	public ArrayList<ConferencePersonModel> getConferencePersonListByID(String conferenceID) {
		// ArrayList<ConferencePersonModel> cpList = new
		// ArrayList<ConferencePersonModel>();
		// Cursor cursor = null;
		// try {
	...
	// }
	//
	// private ConferencePersonModel createConferencePersonFromCursor(Cursor
	// cursor) {
